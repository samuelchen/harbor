...
-- cw: changed from replication_target
create table registry (
 id SERIAL NOT NULL,
 name varchar(64),
 url varchar(256),
 access_key varchar(255),
 access_secret varchar(4096),
 /*
...
CREATE TRIGGER harbor_user_update_time_at_modtime BEFORE UPDATE ON harbor_user FOR EACH ROW 
BEGIN
