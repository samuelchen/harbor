...
-- cw: TODO: comment now, check if there is data to be updated. 
...
-- UPDATE replication_policy SET override=TRUE;     -- TODO: check later
...
ALTER TABLE replication_job CHANGE COLUMN job_uuid job_id varchar(64);
...
ALTER TABLE replication_job DROP INDEX policy;
ALTER TABLE replication_job DROP INDEX poid_uptime;
ALTER TABLE replication_job DROP INDEX poid_status;
...
*/
-- cw: TODO: check later. so far no data
-- DO $$
-- BEGIN
