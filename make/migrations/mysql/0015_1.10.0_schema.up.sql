...
ALTER TABLE img_scan_job DROP INDEX idx_status;
ALTER TABLE img_scan_job DROP INDEX idx_digest;
ALTER TABLE img_scan_job DROP INDEX idx_uuid;
ALTER TABLE img_scan_job DROP INDEX idx_repository_tag;
