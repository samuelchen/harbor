...
ALTER TABLE artifact CHANGE COLUMN kind type varchar(255);
ALTER TABLE artifact DROP COLUMN creation_time;

/*set the media type*/
-- cw: TODO: check later. so far no data for new install.
...
ALTER TABLE replication_task MODIFY COLUMN src_resource varchar(512);
ALTER TABLE replication_task MODIFY COLUMN dst_resource varchar(512);
